...
const { CloseConnection } = require('../../../mongoDB/containerFiles/mongo');

async function CreateCountriesDB(db) {
  console.log(`Creating ${dbConfig.COUNTRIES}...`);
  db.createCollection(dbConfig.COUNTRIES, {
    validator: {
      $jsonSchema: {
        bsonType: "object",
...
async function InsertCountries(db) {
  ...
  try {
    ...
    for (country in countryNames) {
      let { insertedID } = await db.collection(`${dbConfig.COUNTRIES}`).insertOne(countryNames[country]);
...
module.exports = { CreateCountriesDB};
